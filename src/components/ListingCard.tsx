  ...
  return (
    <article className="mb-5 inline-block w-full break-inside-avoid">
      <button type="button" onClick={() => onSelect?.(group)} className="group block w-full text-left">
        <div className={`relative flex min-h-40 items-center justify-center overflow-hidden rounded-[22px] ${canvasClass}`}>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-end justify-between">
        ...
        <span className="whitespace-nowrap text-[15px] font-semibold text-[#E0B71D]">{listing.price ?? "Open"}</span>
      </div>
    </a>
  );
}
